...
namespace netvars {
	...
	constexpr ptrdiff_t dwEntityList = 0x4DFFFB4;
	constexpr ptrdiff_t dwForceAttack = 0x322DDEC;
	constexpr ptrdiff_t dwForceAttack2 = 0x322DDF8;
	constexpr ptrdiff_t dwForceBackward = 0x322DE40;
	constexpr ptrdiff_t dwForceForward = 0x322DE34;
	constexpr ptrdiff_t dwForceJump = 0x52BBD48;
	constexpr ptrdiff_t dwForceLeft = 0x322DE4C;
	constexpr ptrdiff_t dwForceRight = 0x322DDB0;
	constexpr ptrdiff_t dwGameDir = 0x63AD80;
	constexpr ptrdiff_t dwGameRulesProxy = 0x532F56C;
	constexpr ptrdiff_t dwGetAllClasses = 0xE0BF8C;
	constexpr ptrdiff_t dwGlobalVars = 0x59EE60;
	constexpr ptrdiff_t dwGlowObjectManager = 0x535AA70;
	constexpr ptrdiff_t dwInput = 0x525D588;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x99C224;
	constexpr ptrdiff_t dwLocalPlayer = 0xDEA964;
	constexpr ptrdiff_t dwMouseEnable = 0x52391E8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0x52391B8;
	constexpr ptrdiff_t dwPlayerResource = 0x322C160;
	constexpr ptrdiff_t dwRadarBase = 0x5236A8C;
	...
	constexpr ptrdiff_t dwViewMatrix = 0x4DF0DE4;
	constexpr ptrdiff_t dwWeaponTable = 0x525E664;
	...
	constexpr ptrdiff_t find_hud_element = 0x5AE80090;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3D96FA;
	constexpr ptrdiff_t interface_engine_cvar = 0x3FA9C;
	constexpr ptrdiff_t is_c4_owner = 0x3E6F10;
	...
	constexpr ptrdiff_t m_pitchClassPtr = 0x52390E0;
	constexpr ptrdiff_t m_yawClassPtr = 0xDEE910;
	constexpr ptrdiff_t model_ambient_min = 0x5A1194;
	constexpr ptrdiff_t set_abs_angles = 0x1E76F0;
	constexpr ptrdiff_t set_abs_origin = 0x1E7530;
